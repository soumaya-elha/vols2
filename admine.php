...
if (isset($_SESSION['admin'])) {
    ...
    $pagetitle = 'Vols';
    $noHeader = '';
    $titleOfPage = 'Gestion des vols';
    include "nav.php"; // include nav

    $do = isset($_GET['do']) ? $_GET['do'] : 'vol';
...
?>
        ...
        <div class="container">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">date de departt</th>
                            <th scope="col">Time</th>
                            <th scope="col">Price </th>
                            <th scope="col">nombre de Place</th>
                            <th scope="col">ajoute</th>
            ...
            <a href="?do=add" class="btn btn-primary"><i class="fas fa-plus"></i>Ajouter vol</a>
        </div>
